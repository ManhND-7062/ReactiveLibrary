...
if arg[1] then
  arg[1] = arg[1]:gsub('^(tests/operators/)', ''):gsub('%.test.lua$', '')
  dofile('tests/operators/' .. arg[1] .. '.test.lua')
else
  local files = {
    'core/observer',
    'core/observable',
    ...
    'core/subjects/behaviorsubject',
    'core/subjects/replaysubject'
  }

  for i, file in ipairs(files) do
    dofile('tests/' .. file .. '.test.lua')
